...
<type>
    ...
    <destination>Lapack.ctrtrs</destination>
    <destination>Lapack.strtrs</destination>
</type>
<type>
    <source locate="after">
        notANumber
    ...
    <destination>new fcomplex(float.NaN,float.NaN)</destination>
    <destination>float.NaN</destination>
</type>
<type>
    <source locate="after">
        lapack_*getrf
...
<type>
    ...
    <destination>Lapack.cgetrs</destination>
    <destination>Lapack.sgetrs</destination>
</type>
<type>
    <source locate="after">
        lapack_*potrs
    ...
    <destination>Lapack.cpotrs</destination>
    <destination>Lapack.spotrs</destination>
</type>
<type>
    <source locate="after">
        lapack_*potrf
...
<type>
    ...
    <destination>Lapack.cgelsy</destination>
    <destination>Lapack.sgelsy</destination>
</type>
<type>
    <source locate="after">
        HycalpEPS
...
// DO NOT EDIT INSIDE THIS REGION !! CHANGES WILL BE LOST !! 
        ...
        /// <para>Compatibility with Matlab<sup>(R)</sup>: If A is square, the algorithm used follows the same logic as Matlab up to Rel 14, with the exception of Hessenberg matrices wich are solved via LU factorization here. The un-squared case is handled differently. A direct Lapack driver function (?gelsy) is used here. Therefore the solutions might differ! However, the solution will of course fullfill the equation A * x = B without round off errrors. </para>
        /// <para>For specifiying the rank of A in the unsquare case (q != n), the eps member from <see cref="ILNumerics.Settings.ILSettings"/> class is used.</para></remarks>
        public static  ILArray<float> linsolve( ILArray<float> A,  ILArray<float> B) {
            if (object.Equals(A,null) || object.Equals(B,null))
                throw new ILArgumentException("linsolve: parameter must not be null!");
            MatrixProperties props = MatrixProperties.None;
            if (A.Dimensions[0] == A.Dimensions[1]) {
        ...
        /// <para>Compatibility with Matlab<sup>(R)</sup>: If A is square, the algorithm used follows the same logic as Matlab up to Rel 14, with the exception of Hessenberg matrices wich are solved via LU factorization here. The un-squared case is handled differently. A direct Lapack driver function (?gelsy) is used here. Therefore the solutions might differ! However, the solution will of course fullfill the equation A * x = B without round off errrors. </para>
        /// <para>For specifiying the rank of A in the unsquare case (q != n), the eps member from <see cref="ILNumerics.Settings.ILSettings"/> class is used.</para></remarks>
        public static  ILArray<float> linsolve( ILArray<float> A,  ILArray<float> B, ref MatrixProperties props) {
            if (object.Equals(A,null)) 
                throw new ILArgumentException("linsolve: input argument A must not be null!"); 
            if (object.Equals(B,null))
                throw new ILArgumentException("linsolve: input argument B must not be null!"); 
            ...
            if (m == A.Dimensions[1]) {
                ...
                if ((props & MatrixProperties.Hermitian) != 0) {
                    ILArray<float> cholFact = A.copyUpperTriangle(m);
                    Lapack.spotrf ('U', m, cholFact.m_data, m, ref info); 
                    if (info > 0) {
                        props ^= MatrixProperties.Hermitian; 
                        return null; 
                    }  else {
                        // solve 
                        ret = ( ILArray<float> )B.Clone(); 
                        Lapack.spotrs ('U',m,B.Dimensions[1],cholFact.m_data,m,ret.m_data,m,ref info);   
                        return ret; 
                    } 
                } else {
                    // attempt complete (expensive) LU factorization 
                    ...
                    if (info > 0)
                        props |= MatrixProperties.Singular; 
                    ret = ( ILArray<float> )B.Clone(); 
                    Lapack.sgetrs ('N',m,B.Dimensions[1],L.m_data,m,pivInd,ret.m_data,m,ref info); 
                    if (info < 0) 
                        throw new ILArgumentException("linsolve: failed to solve via lapack dgetrs");
                    return ret; 
                }
                ...
                if (m < n) {
                    ret = new  ILArray<float> (new  float [n * nrhs],n,nrhs);
                    ret["0:"+(m-1)+";:"] = B;
                } else {
                    ret = ( ILArray<float> )B.Clone();
                }
                int [] JPVT = new int [n]; 
                Lapack.sgelsy (m, n, B.Dimensions[1], tmpA.m_data, m, ret.m_data, 
                                    maxMN, JPVT,  ILMath.MachineParameterFloat.eps ,
                                    ref rank, ref info); 
                if (n < m) {
                    ret = ret[ILMath.vector(0,n-1),null];
                }
        ...
        /// <para>Elements of A below the main diagonal will not be accessed.</para>
        /// <para>If A has been found to be singular, the array returned will contain NaN values for corresponding elements!</para></remarks>
        internal static  ILArray<float> solveUpperTriangularSystem ( ILArray<float> A,  ILArray<float> B, ref int singularityDetect) {
            System.Diagnostics.Debug.Assert(B.Dimensions[1] >= 0); 
            System.Diagnostics.Debug.Assert(B.Dimensions[0] == A.Dimensions[1]); 
            System.Diagnostics.Debug.Assert(A.Dimensions[0] == A.Dimensions[1]); 
            singularityDetect = -1; 
            ...
            int spacingA0, spacingA1, info = 0; 
            char transA; 
            ILArray<float> ret = ( ILArray<float> )B.Clone();
            float [] retArr = ret.m_data;  
            if (isSuitableForLapack(A,out spacingA0,out spacingA1,out transA)) {
                // solve using Lapack
                unsafe {
                    fixed ( float * ptrA = A.m_data) 
                    fixed ( float * ptrB = ret.m_data) {
                        float * pA = ptrA + A.getBaseIndex(0); 
                        Lapack.strtrs ((transA == 'T')? 'L':'U',transA,'N',A.Dimensions[0],ret.Dimensions[1],(IntPtr)pA,spacingA1,(IntPtr)ptrB,n,ref info);
                        if (info < 0) 
                            throw new ILArgumentException ("linsolve: error inside Lapack function ?trtrs for argument: " + (-info));
                        if (info > 0) {
                            singularityDetect = info-1;
            ...
            for (int b = 0; b < m; b++) {
                for (int r = n; r --> 0;) {
                    ...
                    if (diagVal ==  0.0f ) {
                        singularityDetect = r; 
                        for (; r --> 0;)
                            retArr[r + b * n] =  float.PositiveInfinity ; 
                    } else {
                        for (int c = r+1; c < n; c++) {
                            tmpVal += A.m_data[Adim0[r] + Adim1[c]] * retArr[c + b * n]; 
                        }
            ...
            ret = new  ILArray<float> (retArr,n,m); 
            return ret; 
        }
        ...
        /// <para>Elements of A above the main diagonal will not be accessed.</para>
        /// <para>If A has been found to be singular, the array returned will contain NaN values for corresponding elements!</para></remarks>
        internal static  ILArray<float> solveLowerTriangularSystem ( ILArray<float> A,  ILArray<float> B, ref int singularityDetect) {
            System.Diagnostics.Debug.Assert(B.Dimensions[1] >= 0); 
            System.Diagnostics.Debug.Assert(B.Dimensions[0] == A.Dimensions[1]); 
            System.Diagnostics.Debug.Assert(A.Dimensions[0] == A.Dimensions[1]); 
            singularityDetect = -1; 
            ...
            if (isSuitableForLapack(A,out spacingA0,out spacingA1,out transA)) {
                ...
                unsafe {
                    ...
                    fixed ( float * ptrB = ret.m_data) {
                        float * pA = ptrA + A.getBaseIndex(0); 
                        Lapack.strtrs ((transA == 'T')? 'U':'L',transA,'N',A.Dimensions[0],ret.Dimensions[1],(IntPtr)pA,spacingA1,(IntPtr)ptrB,n,ref info);
                        if (info < 0) 
                            throw new ILArgumentException ("linsolve: error inside Lapack function ?trtrs for argument: " + (-info));
                        if (info > 0) {
                            singularityDetect = info-1;
        ...
        /// <para>Compatibility with Matlab<sup>(R)</sup>: If A is square, the algorithm used follows the same logic as Matlab up to Rel 14, with the exception of Hessenberg matrices wich are solved via LU factorization here. The un-squared case is handled differently. A direct Lapack driver function (?gelsy) is used here. Therefore the solutions might differ! However, the solution will of course fullfill the equation A * x = B without round off errrors. </para>
        /// <para>For specifiying the rank of A in the unsquare case (q != n), the eps member from <see cref="ILNumerics.Settings.ILSettings"/> class is used.</para></remarks>
        public static  ILArray<fcomplex> linsolve( ILArray<fcomplex> A,  ILArray<fcomplex> B) {
            if (object.Equals(A,null) || object.Equals(B,null))
                throw new ILArgumentException("linsolve: parameter must not be null!");
            MatrixProperties props = MatrixProperties.None;
            if (A.Dimensions[0] == A.Dimensions[1]) {
        ...
        /// <para>Compatibility with Matlab<sup>(R)</sup>: If A is square, the algorithm used follows the same logic as Matlab up to Rel 14, with the exception of Hessenberg matrices wich are solved via LU factorization here. The un-squared case is handled differently. A direct Lapack driver function (?gelsy) is used here. Therefore the solutions might differ! However, the solution will of course fullfill the equation A * x = B without round off errrors. </para>
        /// <para>For specifiying the rank of A in the unsquare case (q != n), the eps member from <see cref="ILNumerics.Settings.ILSettings"/> class is used.</para></remarks>
        public static  ILArray<fcomplex> linsolve( ILArray<fcomplex> A,  ILArray<fcomplex> B, ref MatrixProperties props) {
            if (object.Equals(A,null)) 
                throw new ILArgumentException("linsolve: input argument A must not be null!"); 
            if (object.Equals(B,null))
                throw new ILArgumentException("linsolve: input argument B must not be null!"); 
            ...
            if (m == A.Dimensions[1]) {
                ...
                if ((props & MatrixProperties.Hermitian) != 0) {
                    ILArray<fcomplex> cholFact = A.copyUpperTriangle(m);
                    Lapack.cpotrf ('U', m, cholFact.m_data, m, ref info); 
                    if (info > 0) {
                        props ^= MatrixProperties.Hermitian; 
                        return null; 
                    }  else {
                        // solve 
                        ret = ( ILArray<fcomplex> )B.Clone(); 
                        Lapack.cpotrs ('U',m,B.Dimensions[1],cholFact.m_data,m,ret.m_data,m,ref info);   
                        return ret; 
                    } 
                } else {
                    // attempt complete (expensive) LU factorization 
                    ...
                    if (info > 0)
                        props |= MatrixProperties.Singular; 
                    ret = ( ILArray<fcomplex> )B.Clone(); 
                    Lapack.cgetrs ('N',m,B.Dimensions[1],L.m_data,m,pivInd,ret.m_data,m,ref info); 
                    if (info < 0) 
                        throw new ILArgumentException("linsolve: failed to solve via lapack dgetrs");
                    return ret; 
                }
                ...
                if (m < n) {
                    ret = new  ILArray<fcomplex> (new  fcomplex [n * nrhs],n,nrhs);
                    ret["0:"+(m-1)+";:"] = B;
                } else {
                    ret = ( ILArray<fcomplex> )B.Clone();
                }
                int [] JPVT = new int [n]; 
                Lapack.cgelsy (m, n, B.Dimensions[1], tmpA.m_data, m, ret.m_data, 
                                    maxMN, JPVT,  ILMath.MachineParameterFloat.eps ,
                                    ref rank, ref info); 
                if (n < m) {
                    ret = ret[ILMath.vector(0,n-1),null];
        ...
        /// <para>Elements of A below the main diagonal will not be accessed.</para>
        /// <para>If A has been found to be singular, the array returned will contain NaN values for corresponding elements!</para></remarks>
        internal static  ILArray<fcomplex> solveUpperTriangularSystem ( ILArray<fcomplex> A,  ILArray<fcomplex> B, ref int singularityDetect) {
            System.Diagnostics.Debug.Assert(B.Dimensions[1] >= 0); 
            System.Diagnostics.Debug.Assert(B.Dimensions[0] == A.Dimensions[1]); 
            System.Diagnostics.Debug.Assert(A.Dimensions[0] == A.Dimensions[1]); 
            singularityDetect = -1; 
            ...
            if (isSuitableForLapack(A,out spacingA0,out spacingA1,out transA)) {
                ...
                unsafe {
                    ...
                    fixed ( fcomplex * ptrB = ret.m_data) {
                        ...
                        Lapack.ctrtrs ((transA == 'T')? 'L':'U',transA,'N',A.Dimensions[0],ret.Dimensions[1],(IntPtr)pA,spacingA1,(IntPtr)ptrB,n,ref info);
                        if (info < 0) 
                            throw new ILArgumentException ("linsolve: error inside Lapack function ?trtrs for argument: " + (-info));
                        if (info > 0) {
                            singularityDetect = info-1;
