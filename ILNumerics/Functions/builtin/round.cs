...
<hycalper>
    ...
    <type>
        ...
        <destination>Round to nearest integer</destination>
        <destination>Round to nearest integer</destination>
        <destination>Round to nearest integer</destination>
        <destination>Round to nearest integer</destination>
    </type>
    <type>
        ...
        <destination>Array of same size as A with elements rounded to nearest integer</destination>
        <destination>Array of same size as A with elements rounded to nearest integer</destination>
        <destination>Array of same size as A with elements rounded to nearest integer</destination>
        <destination>Array of same size as A with elements rounded to nearest integer</destination>
    </type>
...
// DO NOT EDIT INSIDE THIS REGION !! CHANGES WILL BE LOST !! 
                            ...
                            fixed ( complex * pInArr = A.m_data) {
                                ...
                                while (secDimIdx < secDimEnd) {
                                    ...
                                    while (leadDimIdx < leadDimEnd) {   // HC00
                                        ...
                                        *tmpOut =  complex.Round ( *( tmpIn + *leadDimIdx++ ) )  ;
                                        tmpOut += incOut;
                                    }
                                }
                            }
                            ...
                            fixed ( fcomplex * pInArr = A.m_data) {
                                ...
                                while (secDimIdx < secDimEnd) {
                                    ...
                                    while (leadDimIdx < leadDimEnd) {   // HC00
                                        ...
                                        *tmpOut =  fcomplex.Round ( *( tmpIn + *leadDimIdx++ ) )  ;
                                        tmpOut += incOut;
                                    }
                                }
                            }
                            ...
                            fixed ( float * pInArr = A.m_data) {
                                ...
                                while (secDimIdx < secDimEnd) {
                                    ...
                                    while (leadDimIdx < leadDimEnd) {   // HC00
                                        ...
                                        *tmpOut =  (float)Math.Round ( *( tmpIn + *leadDimIdx++ ) )  ;
                                        tmpOut += incOut;
                                    }
                                }
                            }
        ...
        /// <remarks><para>If the input array is empty, an empty array will be returned.</para>
        /// <para>The array returned will be a dense array.</para></remarks>
        public static  ILArray<double>  round ( ILArray<double> A) {
            if (A.IsEmpty)
                            ...
                            fixed ( double * pInArr = A.m_data) {
                                ...
                                while (secDimIdx < secDimEnd) {
                                    ...
                                    while (leadDimIdx < leadDimEnd) {   // HC00
                                        ...
                                        *tmpOut =  Math.Round ( *( tmpIn + *leadDimIdx++ ) )  ;
                                        tmpOut += incOut;
                                    }
                                }
                            }
