...
<hycalper>
    ...
    <type>
        ...
        <destination>Math.Log</destination>
        <destination>(float)Math.Log</destination>
        <destination>fcomplex.Log</destination>
        <destination>complex.Log</destination>
        <destination>complex.Log</destination>
        <destination>fcomplex.Log</destination>
    </type>
    <type>
    ...
    <type>
        ...
        <destination>Logarithm of array elements - real output</destination>
        <destination>Logarithm of array elements - real output</destination>
        <destination>Logarithm of array elements</destination>
        <destination>Logarithm of array elements</destination>
        <destination>Logarithm of array elements - complex output</destination>
        <destination>Logarithm of array elements - complex output</destination>
    </type>
    <type>
        <source locate="comment">
        ...
        <destination>Logarithm of array elements - real output</destination>
        <destination>Logarithm of array elements - real output</destination>
        <destination>Complex logarithm of array elements</destination>
        <destination>Complex logarithm of array elements</destination>
        <destination>Complex logarithm of array elements</destination>
        <destination>Complex logarithm of array elements</destination>
    </type>
...
// DO NOT EDIT INSIDE THIS REGION !! CHANGES WILL BE LOST !! 
        ...
        public static  ILArray<fcomplex>  logc ( ILArray<float> A) {
            if (A.IsEmpty)
                            ...
                            fixed ( float * pInArr = A.m_data) {
                                ...
                                while (secDimIdx < secDimEnd) {
                                    ...
                                    while (leadDimIdx < leadDimEnd) {   // HC00
                                        ...
                                        *tmpOut =  fcomplex.Log ( *( tmpIn + *leadDimIdx++ ) )  ;
                                        tmpOut += incOut;
                                    }
                                }
                            }
        ...
        /// <remarks><para>If the input array is empty, an empty array will be returned.</para>
        /// <para>The array returned will be a solid array.</para></remarks>
        public static  ILArray<complex>  logc ( ILArray<double> A) {
            if (A.IsEmpty)
                            ...
                            fixed ( double * pInArr = A.m_data) {
                                ...
                                while (secDimIdx < secDimEnd) {
                                    ...
                                    while (leadDimIdx < leadDimEnd) {   // HC00
                                        ...
                                        *tmpOut =  complex.Log ( *( tmpIn + *leadDimIdx++ ) )  ;
                                        tmpOut += incOut;
                                    }
                                }
                            }
        ...
        /// <remarks><para>If the input array is empty, an empty array will be returned.</para>
        /// <para>The array returned will be a solid array.</para></remarks>
        public static  ILArray<complex>  log ( ILArray<complex> A) {
            if (A.IsEmpty)
                return  ILArray<complex> .empty(); 
            ILDimension inDim = A.Dimensions;
            complex [] retDblArr;
        ...
        /// <remarks><para>If the input array is empty, an empty array will be returned.</para>
        /// <para>The array returned will be a solid array.</para></remarks>
        public static  ILArray<fcomplex>  log ( ILArray<fcomplex> A) {
            if (A.IsEmpty)
                return  ILArray<fcomplex> .empty(); 
            ILDimension inDim = A.Dimensions;
            fcomplex [] retDblArr;
        ...
        /// <remarks><para>If the input array is empty, an empty array will be returned.</para>
        /// <para>The array returned will be a solid array.</para></remarks>
        public static  ILArray<float>  log ( ILArray<float> A) {
            if (A.IsEmpty)
                            ...
                            fixed ( float * pInArr = A.m_data) {
                                ...
                                while (secDimIdx < secDimEnd) {
                                    ...
                                    while (leadDimIdx < leadDimEnd) {   // HC00
                                        ...
                                        *tmpOut =  (float)Math.Log ( *( tmpIn + *leadDimIdx++ ) )  ;
                                        tmpOut += incOut;
                                    }
                                }
                            }
        ...
        /// <remarks><para>If the input array is empty, an empty array will be returned.</para>
        /// <para>The array returned will be a solid array.</para></remarks>
        public static  ILArray<double>  log ( ILArray<double> A) {
            if (A.IsEmpty)
                            ...
                            fixed ( double * pInArr = A.m_data) {
                                ...
                                while (secDimIdx < secDimEnd) {
                                    ...
                                    while (leadDimIdx < leadDimEnd) {   // HC00
                                        ...
                                        *tmpOut =  Math.Log ( *( tmpIn + *leadDimIdx++ ) )  ;
                                        tmpOut += incOut;
                                    }
                                }
                            }
