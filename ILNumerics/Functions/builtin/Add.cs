    ...
    public partial class ILMath {         
        ...
        public static /*!HC:outCls*/ ILArray<double> /*!HC:HCFuncName*/ add (/*!HC:inCls1*/ ILArray<double> A, /*!HC:inCls2*/ ILArray<double> B) {
            ...
            if (A.IsScalar) {
                if (B.IsScalar) {
                    /*!HC:HCCompute00*/
                    return new /*!HC:outCls*/ ILArray<double> (new /*!HC:outArr*/ double [1]{/*!HC:outCast*/ /**/ (A.GetValue(0) /*!HC:HCoperation*/ + B.GetValue(0))});
                } else {
                    #region scalar + array  
                    ILDimension inDim = B.Dimensions;
                    // /*!HC:outArr*/ double [] retArr = new /*!HC:outArr*/ double [inDim.NumberOfElements];
                    /*!HC:outArr*/ double [] retArr = ILMemoryPool.Pool.New</*!HC:outArr*/ double > (inDim.NumberOfElements);
                    /*!HC:inArr1*/ double scalarValue = A.GetValue(0); 
                    /*!HC:inArr2*/ double tmpValue2; 
                        ...
                        if (B.IsMatrix) {
                                ...
                                fixed (/*!HC:inArr2*/ double * pInArr = B.m_data) {
                                        ...
                                        while (secDimIdx < secDimEnd) {
                                            ...
                                            while (leadDimIdx < leadDimEnd) {
                                                /*!HC:HCCompute01*/
                                                *tmpOut = /*!HC:outCast*/ /**/ (scalarValue /*!HC:HCoperation*/ + (*( tmpIn + *leadDimIdx++ )));
                                                tmpOut += incOut;
                                            }
                                        }
                                }
                            ...
                            unsafe {
                                ...
                                fixed (int* leadDimStart = idxOffset [leadDim]) {
                                    ...
                                    fixed (/*!HC:inArr2*/ double * pInArr = B.m_data) {
                                        /*!HC:outArr*/ double * tmpOut = pOutArr;
                                        /*!HC:outArr*/ double * tmpOutEnd = tmpOut + retArr.Length;
                                        // init lesezeiger: add alle Dimensionen mit 0 (auer leadDim)
                                        /*!HC:inArr2*/ double * tmpIn = pInArr + B.getBaseIndex (0,0);
                    ...
                    return new /*!HC:outCls*/ ILArray<double> ( retArr, inDim.Clone() );
                ...
                if (B.IsScalar) {
                    ...
                    // /*!HC:outArr*/ double [] retArr = new /*!HC:outArr*/ double [inDim.NumberOfElements];
                    /*!HC:outArr*/ double [] retArr = ILMemoryPool.Pool.New</*!HC:outArr*/ double > (inDim.NumberOfElements);
                    /*!HC:inArr2*/ double scalarValue = B.GetValue(0); 
                    /*!HC:inArr1*/ double tmpValue1;
                    int leadDim = 0,leadDimLen = inDim [0];
                    if (A.IsReference) {
                        #region Reference storage
                        // walk along the longest dimension (for performance reasons)
                                ...
                                fixed (/*!HC:inArr1*/ double * pInArr = A.m_data) {
                                        ...
                                        while (secDimIdx < secDimEnd) {
                                            ...
                                            while (leadDimIdx < leadDimEnd) { //HC04
                                                /*!HC:HCCompute04*/ 
                                                *tmpOut = /*!HC:outCast*/ /**/ (*( tmpIn + *leadDimIdx++ ) /*!HC:HCoperation*/ + scalarValue);
                                                tmpOut += incOut;
                                            }
                                        }
                                }
                    ...
                    /*!HC:inArr1*/ double tmpValue1; 
                    /*!HC:inArr2*/ double tmpValue2; 
                    // retSystemArr = new /*!HC:outArr1*/ double [inDim.NumberOfElements];
                    retSystemArr = ILMemoryPool.Pool.New</*!HC:outArr1*/ double > (inDim.NumberOfElements);
                            ...
                            if (A.IsReference) { 
                                if (!B.IsReference) {
                                    while (poutarr < outEnd) {  //HC07
                                        /*!HC:HCCompute07*/ 
                                        *poutarr++ = /*!HC:outCast*/ /**/ ( *(pInA1 + A.getBaseIndex(c++)) /*!HC:HCoperation*/ + (*pInA2++));
                                    }
                                } else {
                                    ...
                                    if (inDim.NumberOfDimensions < 3) {
                                        ...
                                        fixed (int * pA2idx1 = B.m_indexOffset[1]) {
                                            ...
                                            while (poutarr < outEnd) {   //HC08
                                                /*!HC:HCCompute08*/
                                                *poutarr++ = /*!HC:outCast*/ /**/  ( *(pInA1 + (*(pA1idx0 + r)) + (*(pA1idx1 + c)))/*!HC:HCoperation*/ +  (*(pInA2+ (*(pA2idx0 + r)) + (*(pA2idx1 + c)))));
                                                if (++r == rLen) {
                                                    r = 0; 
                                                    c++; 
                                                }
                                         ...
                                         while (poutarr < outEnd) {  //HC09
                                             /*!HC:HCCompute09*/ 
                                             *poutarr++ = /*!HC:outCast*/ /**/ ( *(pInA1 + A.getBaseIndex(c))/*!HC:HCoperation*/ +  (*(pInA2+B.getBaseIndex(c++))));
                                        }
                                   }
                                ...
                                if (B.IsReference) {
                                    while (poutarr < outEnd) {  //HC10
                                        /*!HC:HCCompute10*/  
                                        *poutarr++ = /*!HC:outCast*/ /**/  ( *pInA1++ /*!HC:HCoperation*/ +  (*(pInA2 + B.getBaseIndex(c++))));
                                    }
                                } else {
                    ...
                    return new /*!HC:outCls*/ ILArray<double> ( retSystemArr, inDim.ToIntArray () );
...
// DO NOT EDIT INSIDE THIS REGION !! CHANGES WILL BE LOST !! 
        ...
        /// <para>A and / or B may be scalar. The scalar value will operate on all elements of the other arrays in this case.</para>
        /// <para>If neither of A or B is scalar or empty, the dimensions of both arrays must match.</para></remarks>
        public static  ILArray<UInt64>  add ( ILArray<UInt64> A,  ILArray<UInt64> B) {
            if (A.IsEmpty || B.IsEmpty ) {
        ...
        /// <para>A and / or B may be scalar. The scalar value will operate on all elements of the other arrays in this case.</para>
        /// <para>If neither of A or B is scalar or empty, the dimensions of both arrays must match.</para></remarks>
        public static  ILArray<UInt32>  add ( ILArray<UInt32> A,  ILArray<UInt32> B) {
            if (A.IsEmpty || B.IsEmpty ) {
        ...
        /// <para>A and / or B may be scalar. The scalar value will operate on all elements of the other arrays in this case.</para>
        /// <para>If neither of A or B is scalar or empty, the dimensions of both arrays must match.</para></remarks>
        public static  ILArray<UInt16>  add ( ILArray<UInt16> A,  ILArray<UInt16> B) {
            if (A.IsEmpty || B.IsEmpty ) {
        ...
        /// <para>A and / or B may be scalar. The scalar value will operate on all elements of the other arrays in this case.</para>
        /// <para>If neither of A or B is scalar or empty, the dimensions of both arrays must match.</para></remarks>
        public static  ILArray<Int64>  add ( ILArray<Int64> A,  ILArray<Int64> B) {
            if (A.IsEmpty || B.IsEmpty ) {
        ...
        /// <para>A and / or B may be scalar. The scalar value will operate on all elements of the other arrays in this case.</para>
        /// <para>If neither of A or B is scalar or empty, the dimensions of both arrays must match.</para></remarks>
        public static  ILArray<Int32>  add ( ILArray<Int32> A,  ILArray<Int32> B) {
            if (A.IsEmpty || B.IsEmpty ) {
        ...
        /// <para>A and / or B may be scalar. The scalar value will operate on all elements of the other arrays in this case.</para>
        /// <para>If neither of A or B is scalar or empty, the dimensions of both arrays must match.</para></remarks>
        public static  ILArray<Int16>  add ( ILArray<Int16> A,  ILArray<Int16> B) {
            if (A.IsEmpty || B.IsEmpty ) {
        ...
        /// <para>A and / or B may be scalar. The scalar value will operate on all elements of the other arrays in this case.</para>
        /// <para>If neither of A or B is scalar or empty, the dimensions of both arrays must match.</para></remarks>
        public static  ILArray<float>  add ( ILArray<float> A,  ILArray<float> B) {
            if (A.IsEmpty || B.IsEmpty ) {
        ...
        /// <para>A and / or B may be scalar. The scalar value will operate on all elements of the other arrays in this case.</para>
        /// <para>If neither of A or B is scalar or empty, the dimensions of both arrays must match.</para></remarks>
        public static  ILArray<fcomplex>  add ( ILArray<fcomplex> A,  ILArray<fcomplex> B) {
            if (A.IsEmpty || B.IsEmpty ) {
        ...
        /// <para>A and / or B may be scalar. The scalar value will operate on all elements of the other arrays in this case.</para>
        /// <para>If neither of A or B is scalar or empty, the dimensions of both arrays must match.</para></remarks>
        public static  ILArray<char>  add ( ILArray<char> A,  ILArray<char> B) {
            if (A.IsEmpty || B.IsEmpty ) {
