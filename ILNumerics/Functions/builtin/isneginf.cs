...
<hycalper>
    ...
    <type>
        ...
        <destination>isneginf</destination>
        <destination>isneginf</destination>
        <destination>isneginf</destination>
        <destination>isneginf</destination>
    </type>
    <type>
        ...
        <destination>complex.IsNegativeInfinity</destination>
        <destination>fcomplex.IsNegativeInfinity</destination>
        <destination>Single.IsNegativeInfinity</destination>
        <destination>Double.IsNegativeInfinity</destination>
    </type>
    <type>
        <source locate="after">
            HCpostOp
    ...
    <type>
        ...
        <destination>Finds negative infinite value elements</destination>
        <destination>Finds negative infinite value elements</destination>
        <destination>Finds negative infinite value elements</destination>
        <destination>Finds negative infinite value elements</destination>
    </type>
    <type>
        ...
        <destination>Logical array with 1 if the corresponding elements of input array is negative infinite, 0 else.</destination>
        <destination>Logical array with 1 if the corresponding elements of input array is negative infinite, 0 else.</destination>
        <destination>Logical array with 1 if the corresponding elements of input array is negative infinite, 0 else.</destination>
        <destination>Logical array with 1 if the corresponding elements of input array is negative infinite, 0 else.</destination>
    </type>
...
// DO NOT EDIT INSIDE THIS REGION !! CHANGES WILL BE LOST !! 
        ...
        public static  ILLogicalArray  isneginf ( ILArray<double> A) {
            if (A.IsEmpty)
                            ...
                            fixed ( double * pInArr = A.m_data) {
                                ...
                                while (secDimIdx < secDimEnd) {
                                    ...
                                    while (leadDimIdx < leadDimEnd) {   // HC00
                                        ...
                                        *tmpOut =  Double.IsNegativeInfinity ( *( tmpIn + *leadDimIdx++ ) )  ?(byte)1:(byte)0;
                                        tmpOut += incOut;
                                    }
                                }
                            }
                ...
                unsafe {
                    ...
                    fixed ( double * pInArr = A.m_data) {
                        ...
                        while (tmpOut < lastElement) { // HC02
                            ...
                            *tmpOut++ =  Double.IsNegativeInfinity ( *tmpIn++ )  ?(byte)1:(byte)0;
                        }
                    }
                }
                #endregion
        ...
        /// <remarks><para>If the input array is empty, an empty array will be returned.</para>
        /// <para>The array returned will be a solid array.</para></remarks>
        public static  ILLogicalArray  isneginf ( ILArray<float> A) {
            if (A.IsEmpty)
                return  ILLogicalArray .empty(); 
            ILDimension inDim = A.Dimensions;
            byte [] retDblArr;
                            ...
                            fixed ( float * pInArr = A.m_data) {
                                ...
                                while (secDimIdx < secDimEnd) {
                                    ...
                                    while (leadDimIdx < leadDimEnd) {   // HC00
                                        ...
                                        *tmpOut =  Single.IsNegativeInfinity ( *( tmpIn + *leadDimIdx++ ) )  ?(byte)1:(byte)0;
                                        tmpOut += incOut;
                                    }
                                }
                            }
                ...
                unsafe {
                    ...
                    fixed ( float * pInArr = A.m_data) {
                        ...
                        while (tmpOut < lastElement) { // HC02
                            ...
                            *tmpOut++ =  Single.IsNegativeInfinity ( *tmpIn++ )  ?(byte)1:(byte)0;
                        }
                    }
                }
                #endregion
        ...
        /// <remarks><para>If the input array is empty, an empty array will be returned.</para>
        /// <para>The array returned will be a solid array.</para></remarks>
        public static  ILLogicalArray  isneginf ( ILArray<fcomplex> A) {
            if (A.IsEmpty)
                return  ILLogicalArray .empty(); 
            ILDimension inDim = A.Dimensions;
            byte [] retDblArr;
                            ...
                            fixed ( fcomplex * pInArr = A.m_data) {
                                ...
                                while (secDimIdx < secDimEnd) {
                                    ...
                                    while (leadDimIdx < leadDimEnd) {   // HC00
                                        ...
                                        *tmpOut =  fcomplex.IsNegativeInfinity ( *( tmpIn + *leadDimIdx++ ) )  ?(byte)1:(byte)0;
                                        tmpOut += incOut;
                                    }
                                }
                            }
                ...
                unsafe {
                    ...
                    fixed ( fcomplex * pInArr = A.m_data) {
                        ...
                        while (tmpOut < lastElement) { // HC02
                            ...
                            *tmpOut++ =  fcomplex.IsNegativeInfinity ( *tmpIn++ )  ?(byte)1:(byte)0;
                        }
                    }
                }
                #endregion
        ...
        /// <remarks><para>If the input array is empty, an empty array will be returned.</para>
        /// <para>The array returned will be a solid array.</para></remarks>
        public static  ILLogicalArray  isneginf ( ILArray<complex> A) {
            if (A.IsEmpty)
                return  ILLogicalArray .empty(); 
            ILDimension inDim = A.Dimensions;
            byte [] retDblArr;
                            ...
                            fixed ( complex * pInArr = A.m_data) {
                                ...
                                while (secDimIdx < secDimEnd) {
                                    ...
                                    while (leadDimIdx < leadDimEnd) {   // HC00
                                        ...
                                        *tmpOut =  complex.IsNegativeInfinity ( *( tmpIn + *leadDimIdx++ ) )  ?(byte)1:(byte)0;
                                        tmpOut += incOut;
                                    }
                                }
                            }
                ...
                unsafe {
                    ...
                    fixed ( complex * pInArr = A.m_data) {
                        ...
                        while (tmpOut < lastElement) { // HC02
                            ...
                            *tmpOut++ =  complex.IsNegativeInfinity ( *tmpIn++ )  ?(byte)1:(byte)0;
                        }
                    }
                }
                #endregion
