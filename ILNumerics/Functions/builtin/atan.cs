...
<hycalper>
    ...
    <type>
        ...
        <destination>Math.Atan</destination>
        <destination>(float)Math.Atan</destination>
        <destination>fcomplex.Atan</destination>
        <destination>complex.Atan</destination>
    </type>
    <type>
        <source locate="after">
            HCfuncname
        </source>
        <destination>atan</destination>
        <destination>atan</destination>
        <destination>atan</destination>
        <destination>atan</destination>
    </type>
    <type>
        ...
        <destination>Arctangent of array elements </destination>
        <destination>Arctangent of array elements</destination>
        <destination>Arctangent of array elements</destination>
        <destination>Arctangent of array elements</destination>
    </type>
...
// DO NOT EDIT INSIDE THIS REGION !! CHANGES WILL BE LOST !! 
        ...
        public static  ILArray<complex>  atan ( ILArray<complex> A) {
            if (A.IsEmpty)
                            ...
                            fixed ( complex * pInArr = A.m_data) {
                                ...
                                while (secDimIdx < secDimEnd) {
                                    ...
                                    while (leadDimIdx < leadDimEnd) {   // HC00
                                        ...
                                        *tmpOut =  complex.Atan ( *( tmpIn + *leadDimIdx++ ) )  ;
                                        tmpOut += incOut;
                                    }
                                }
                            }
        ...
        /// <remarks><para>If the input array is empty, an empty array will be returned.</para>
        /// <para>The array returned will be a dense array.</para></remarks>
        public static  ILArray<fcomplex>  atan ( ILArray<fcomplex> A) {
            if (A.IsEmpty)
                            ...
                            fixed ( fcomplex * pInArr = A.m_data) {
                                ...
                                while (secDimIdx < secDimEnd) {
                                    ...
                                    while (leadDimIdx < leadDimEnd) {   // HC00
                                        ...
                                        *tmpOut =  fcomplex.Atan ( *( tmpIn + *leadDimIdx++ ) )  ;
                                        tmpOut += incOut;
                                    }
                                }
                            }
        ...
        /// <remarks><para>If the input array is empty, an empty array will be returned.</para>
        /// <para>The array returned will be a dense array.</para></remarks>
        public static  ILArray<float>  atan ( ILArray<float> A) {
            if (A.IsEmpty)
                            ...
                            fixed ( float * pInArr = A.m_data) {
                                ...
                                while (secDimIdx < secDimEnd) {
                                    ...
                                    while (leadDimIdx < leadDimEnd) {   // HC00
                                        ...
                                        *tmpOut =  (float)Math.Atan ( *( tmpIn + *leadDimIdx++ ) )  ;
                                        tmpOut += incOut;
                                    }
                                }
                            }
                            ...
                            fixed ( double * pInArr = A.m_data) {
                                ...
                                while (secDimIdx < secDimEnd) {
                                    ...
                                    while (leadDimIdx < leadDimEnd) {   // HC00
                                        ...
                                        *tmpOut =  Math.Atan ( *( tmpIn + *leadDimIdx++ ) )  ;
                                        tmpOut += incOut;
                                    }
                                }
                            }
