...
<hycalper>
    ...
    <type>
        ...
        <destination>Tangens of array elements</destination>
        <destination>Tangens of array elements</destination>
        <destination>Tangens of array elements</destination>
        <destination>Tangens of array elements</destination>
    </type>
...
// DO NOT EDIT INSIDE THIS REGION !! CHANGES WILL BE LOST !! 
        ...
        public static  ILArray<complex>  tan ( ILArray<complex> A) {
            if (A.IsEmpty)
                            ...
                            fixed ( complex * pInArr = A.m_data) {
                                ...
                                while (secDimIdx < secDimEnd) {
                                    ...
                                    while (leadDimIdx < leadDimEnd) {   // HC00
                                        ...
                                        *tmpOut =  complex.Tan ( *( tmpIn + *leadDimIdx++ ) )  ;
                                        tmpOut += incOut;
                                    }
                                }
                            }
        ...
        /// <remarks><para>If the input array is empty, an empty array will be returned.</para>
        /// <para>The array returned will be a solid array.</para></remarks>
        public static  ILArray<fcomplex>  tan ( ILArray<fcomplex> A) {
            if (A.IsEmpty)
                            ...
                            fixed ( fcomplex * pInArr = A.m_data) {
                                ...
                                while (secDimIdx < secDimEnd) {
                                    ...
                                    while (leadDimIdx < leadDimEnd) {   // HC00
                                        ...
                                        *tmpOut =  fcomplex.Tan ( *( tmpIn + *leadDimIdx++ ) )  ;
                                        tmpOut += incOut;
                                    }
                                }
                            }
        ...
        /// <remarks><para>If the input array is empty, an empty array will be returned.</para>
        /// <para>The array returned will be a solid array.</para></remarks>
        public static  ILArray<float>  tan ( ILArray<float> A) {
            if (A.IsEmpty)
                            ...
                            fixed ( float * pInArr = A.m_data) {
                                ...
                                while (secDimIdx < secDimEnd) {
                                    ...
                                    while (leadDimIdx < leadDimEnd) {   // HC00
                                        ...
                                        *tmpOut =  (float)Math.Tan ( *( tmpIn + *leadDimIdx++ ) )  ;
                                        tmpOut += incOut;
                                    }
                                }
                            }
        ...
        /// <remarks><para>If the input array is empty, an empty array will be returned.</para>
        /// <para>The array returned will be a solid array.</para></remarks>
        public static  ILArray<double>  tan ( ILArray<double> A) {
            if (A.IsEmpty)
                            ...
                            fixed ( double * pInArr = A.m_data) {
                                ...
                                while (secDimIdx < secDimEnd) {
                                    ...
                                    while (leadDimIdx < leadDimEnd) {   // HC00
                                        ...
                                        *tmpOut =  Math.Tan ( *( tmpIn + *leadDimIdx++ ) )  ;
                                        tmpOut += incOut;
                                    }
                                }
                            }
