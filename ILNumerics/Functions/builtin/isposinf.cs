...
<hycalper>
    ...
    <type>
        ...
        <destination>Single.IsPositiveInfinity</destination>
    ...
    <type>
        ...
        <destination>Finds positive infinite value elements</destination>
        <destination>Finds positive infinite value elements</destination>
        <destination>Finds positive infinite value elements</destination>
        <destination>Finds positive infinite value elements</destination>
    </type>
    <type>
        ...
        <destination>Logical array with 1 if the corresponding elements of input array is positive infinite, 0 else.</destination>
        <destination>Logical array with 1 if the corresponding elements of input array is positive infinite, 0 else.</destination>
        <destination>Logical array with 1 if the corresponding elements of input array is positive infinite, 0 else.</destination>
        <destination>Logical array with 1 if the corresponding elements of input array is positive infinite, 0 else.</destination>
    </type>
...
// DO NOT EDIT INSIDE THIS REGION !! CHANGES WILL BE LOST !! 
        ...
        public static  ILLogicalArray  isposinf ( ILArray<double> A) {
            if (A.IsEmpty)
                            ...
                            fixed ( double * pInArr = A.m_data) {
                                ...
                                while (secDimIdx < secDimEnd) {
                                    ...
                                    while (leadDimIdx < leadDimEnd) {   // HC00
                                        ...
                                        *tmpOut =  Double.IsPositiveInfinity ( *( tmpIn + *leadDimIdx++ ) )  ?(byte)1:(byte)0;
                                        tmpOut += incOut;
                                    }
                                }
                            }
                ...
                unsafe {
                    ...
                    fixed ( double * pInArr = A.m_data) {
                        ...
                        while (tmpOut < lastElement) { // HC02
                            ...
                            *tmpOut++ =  Double.IsPositiveInfinity ( *tmpIn++ )  ?(byte)1:(byte)0;
                        }
                    }
                }
                #endregion
        ...
        /// <remarks><para>If the input array is empty, an empty array will be returned.</para>
        /// <para>The array returned will be a dense array.</para></remarks>
        public static  ILLogicalArray  isposinf ( ILArray<float> A) {
            if (A.IsEmpty)
                return  ILLogicalArray .empty(); 
            ILDimension inDim = A.Dimensions;
            byte [] retDblArr;
                            ...
                            fixed ( float * pInArr = A.m_data) {
                                ...
                                while (secDimIdx < secDimEnd) {
                                    ...
                                    while (leadDimIdx < leadDimEnd) {   // HC00
                                        ...
                                        *tmpOut =  Single.IsPositiveInfinity ( *( tmpIn + *leadDimIdx++ ) )  ?(byte)1:(byte)0;
                                        tmpOut += incOut;
                                    }
                                }
                            }
                ...
                unsafe {
                    ...
                    fixed ( float * pInArr = A.m_data) {
                        ...
                        while (tmpOut < lastElement) { // HC02
                            ...
                            *tmpOut++ =  Single.IsPositiveInfinity ( *tmpIn++ )  ?(byte)1:(byte)0;
                        }
                    }
                }
                #endregion
        ...
        /// <remarks><para>If the input array is empty, an empty array will be returned.</para>
        /// <para>The array returned will be a dense array.</para></remarks>
        public static  ILLogicalArray  isposinf ( ILArray<fcomplex> A) {
            if (A.IsEmpty)
                return  ILLogicalArray .empty(); 
            ILDimension inDim = A.Dimensions;
            byte [] retDblArr;
                            ...
                            fixed ( fcomplex * pInArr = A.m_data) {
                                ...
                                while (secDimIdx < secDimEnd) {
                                    ...
                                    while (leadDimIdx < leadDimEnd) {   // HC00
                                        ...
                                        *tmpOut =  fcomplex.IsPositiveInfinity ( *( tmpIn + *leadDimIdx++ ) )  ?(byte)1:(byte)0;
                                        tmpOut += incOut;
                                    }
                                }
                            }
                ...
                unsafe {
                    ...
                    fixed ( fcomplex * pInArr = A.m_data) {
                        ...
                        while (tmpOut < lastElement) { // HC02
                            ...
                            *tmpOut++ =  fcomplex.IsPositiveInfinity ( *tmpIn++ )  ?(byte)1:(byte)0;
                        }
                    }
                }
                #endregion
        ...
        /// <remarks><para>If the input array is empty, an empty array will be returned.</para>
        /// <para>The array returned will be a dense array.</para></remarks>
        public static  ILLogicalArray  isposinf ( ILArray<complex> A) {
            if (A.IsEmpty)
                return  ILLogicalArray .empty(); 
            ILDimension inDim = A.Dimensions;
            byte [] retDblArr;
                            ...
                            fixed ( complex * pInArr = A.m_data) {
                                ...
                                while (secDimIdx < secDimEnd) {
                                    ...
                                    while (leadDimIdx < leadDimEnd) {   // HC00
                                        ...
                                        *tmpOut =  complex.IsPositiveInfinity ( *( tmpIn + *leadDimIdx++ ) )  ?(byte)1:(byte)0;
                                        tmpOut += incOut;
                                    }
                                }
                            }
                ...
                unsafe {
                    ...
                    fixed ( complex * pInArr = A.m_data) {
                        ...
                        while (tmpOut < lastElement) { // HC02
                            ...
                            *tmpOut++ =  complex.IsPositiveInfinity ( *tmpIn++ )  ?(byte)1:(byte)0;
                        }
                    }
                }
                #endregion
