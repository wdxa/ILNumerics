                            ...
                            fixed ( complex * pInArr = A.m_data) {
                                ...
                                while (secDimIdx < secDimEnd) {
                                    ...
                                    while (leadDimIdx < leadDimEnd) {   // HC00
                                        ...
                                        *tmpOut =  complex.Ceiling ( *( tmpIn + *leadDimIdx++ ) )  ;
                                        tmpOut += incOut;
                                    }
                                }
                            }
                            ...
                            fixed ( fcomplex * pInArr = A.m_data) {
                                ...
                                while (secDimIdx < secDimEnd) {
                                    ...
                                    while (leadDimIdx < leadDimEnd) {   // HC00
                                        ...
                                        *tmpOut =  fcomplex.Ceiling ( *( tmpIn + *leadDimIdx++ ) )  ;
                                        tmpOut += incOut;
                                    }
                                }
                            }
                            ...
                            fixed ( float * pInArr = A.m_data) {
                                ...
                                while (secDimIdx < secDimEnd) {
                                    ...
                                    while (leadDimIdx < leadDimEnd) {   // HC00
                                        ...
                                        *tmpOut =  (float)Math.Ceiling ( *( tmpIn + *leadDimIdx++ ) )  ;
                                        tmpOut += incOut;
                                    }
                                }
                            }
                ...
                unsafe {
                    ...
                    fixed ( float * pInArr = A.m_data) {
                        ...
                        while (tmpOut < lastElement) { // HC02
                            ...
                            *tmpOut++ =  (float)Math.Ceiling ( *tmpIn++ )  ;
                        }
                    }
                }
                #endregion
                            ...
                            fixed ( double * pInArr = A.m_data) {
                                ...
                                while (secDimIdx < secDimEnd) {
                                    ...
                                    while (leadDimIdx < leadDimEnd) {   // HC00
                                        ...
                                        *tmpOut =  Math.Ceiling ( *( tmpIn + *leadDimIdx++ ) )  ;
                                        tmpOut += incOut;
                                    }
                                }
                            }
