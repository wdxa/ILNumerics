...
<hycalper>
    ...
    <type>
        ...
        <destination>(float)Math.Acos</destination>
        <destination>fcomplex.Acos</destination>
        <destination>complex.Acos</destination>
        <destination>fcomplex.Acos</destination>
        <destination>complex.Acos</destination>
    </type>
    <type>
        ...
        <destination>acos</destination>
        <destination>acos</destination>
        <destination>acos</destination>
        <destination>acos</destination>
        <destination>acosc</destination>
        <destination>acosc</destination>
    </type>
    <type>
        ...
        <destination>Arccosine of array elements - real output</destination>
        <destination>Arccosine of array elements - real output</destination>
        <destination>Arccosine values of array elements</destination>
        <destination>Arccosine values of array elements</destination>
        <destination>Arccosine of array elements - complex output</destination>
        <destination>Arccosine of array elements - complex output</destination>
    </type>
    <type>
        <source locate="comment">
        ...
        <destination>Arccosine of array elements - real output</destination>
        <destination>Arccosine of array elements - real output</destination>
        <destination>Arccosine of array elements</destination>
        <destination>Arccosine of array elements</destination>
        <destination>Arccosine of array elements - complex output</destination>
        <destination>Arccosine of array elements - complex output</destination>
    </type>
...
// DO NOT EDIT INSIDE THIS REGION !! CHANGES WILL BE LOST !! 
        ...
        public static  ILArray<complex>  acosc ( ILArray<double> A) {
            if (A.IsEmpty)
                            ...
                            fixed ( double * pInArr = A.m_data) {
                                ...
                                while (secDimIdx < secDimEnd) {
                                    ...
                                    while (leadDimIdx < leadDimEnd) {   // HC00
                                        ...
                                        *tmpOut =  complex.Acos ( *( tmpIn + *leadDimIdx++ ) )  ;
                                        tmpOut += incOut;
                                    }
                                }
                            }
        ...
        /// <remarks><para>If the input array is empty, an empty array will be returned.</para>
        /// <para>The array returned will be a dense array.</para></remarks>
        public static  ILArray<fcomplex>  acosc ( ILArray<float> A) {
            if (A.IsEmpty)
                            ...
                            fixed ( float * pInArr = A.m_data) {
                                ...
                                while (secDimIdx < secDimEnd) {
                                    ...
                                    while (leadDimIdx < leadDimEnd) {   // HC00
                                        ...
                                        *tmpOut =  fcomplex.Acos ( *( tmpIn + *leadDimIdx++ ) )  ;
                                        tmpOut += incOut;
                                    }
                                }
                            }
        ...
        /// <remarks><para>If the input array is empty, an empty array will be returned.</para>
        /// <para>The array returned will be a dense array.</para></remarks>
        public static  ILArray<complex>  acos ( ILArray<complex> A) {
            if (A.IsEmpty)
                return  ILArray<complex> .empty(); 
            ILDimension inDim = A.Dimensions;
            complex [] retDblArr;
        ...
        /// <remarks><para>If the input array is empty, an empty array will be returned.</para>
        /// <para>The array returned will be a dense array.</para></remarks>
        public static  ILArray<fcomplex>  acos ( ILArray<fcomplex> A) {
            if (A.IsEmpty)
                return  ILArray<fcomplex> .empty(); 
            ILDimension inDim = A.Dimensions;
            fcomplex [] retDblArr;
        ...
        /// <remarks><para>If the input array is empty, an empty array will be returned.</para>
        /// <para>The array returned will be a dense array.</para></remarks>
        public static  ILArray<float>  acos ( ILArray<float> A) {
            if (A.IsEmpty)
                            ...
                            fixed ( float * pInArr = A.m_data) {
                                ...
                                while (secDimIdx < secDimEnd) {
                                    ...
                                    while (leadDimIdx < leadDimEnd) {   // HC00
                                        ...
                                        *tmpOut =  (float)Math.Acos ( *( tmpIn + *leadDimIdx++ ) )  ;
                                        tmpOut += incOut;
                                    }
                                }
                            }
        ...
        /// <remarks><para>If the input array is empty, an empty array will be returned.</para>
        /// <para>The array returned will be a dense array.</para></remarks>
        public static  ILArray<double>  acos ( ILArray<double> A) {
            if (A.IsEmpty)
                            ...
                            fixed ( double * pInArr = A.m_data) {
                                ...
                                while (secDimIdx < secDimEnd) {
                                    ...
                                    while (leadDimIdx < leadDimEnd) {   // HC00
                                        ...
                                        *tmpOut =  Math.Acos ( *( tmpIn + *leadDimIdx++ ) )  ;
                                        tmpOut += incOut;
                                    }
                                }
                            }
