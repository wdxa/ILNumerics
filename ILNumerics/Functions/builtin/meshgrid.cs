...
namespace ILNumerics.BuiltInFunctions {
    ...
    public partial class ILMath
    {
        ...
        /// <returns>A List of two arrays, the x vector values along the first dimension of the first array, and y vector values along the second dimension of the second array</returns>
        /// <remarks></remarks>
        public static List<ILArray<double>> meshgrid(ILArray<double> x, ILArray<double> y)
        {
            ...
            retList.Add(new ILArray<double>(retArrX, dimRet));
            retList.Add(new ILArray<double>(retArrY, dimRet));
            return retList;
        }
        ...
        public static List<ILArray<double>> meshgrid(ILArray<double> x, ILArray<double> y, ILArray<double> z)
        {
            ...
            retList.Add(new ILArray<double>(retArrX, dimRet));
            retList.Add(new ILArray<double>(retArrY, dimRet));
            retList.Add(new ILArray<double>(retArrZ, dimRet));
            return retList;
        }
    }
}
