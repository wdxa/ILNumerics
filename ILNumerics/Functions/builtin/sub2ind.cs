...
namespace ILNumerics.BuiltInFunctions {
    public partial class ILMath {
        ...
        /// <returns>sequential index for subscript indices</returns>
        /// <remarks>the function returns the sequential index i into A referencing the same element as would be referenced by the subscript indices. <br />This is an alias for A.getBaseIndex(in[])</remarks>
        public static int sub2ind(ILArray<float>    A,int [] subscripts) {              
            if (object.Equals(A,null) || A.IsEmpty || subscripts == null || subscripts.Length == 0) 
                throw new ILArgumentException("sub2ind: both A and subscripts must be non-empty!");
            return A.getBaseIndex(subscripts);  
        }
        ...
        /// <returns>sequential index for subscript indices</returns>
        /// <remarks>the function returns the sequential index i into A referencing the same element as would be referenced by the subscript indices. <br />This is an alias for A.getBaseIndex(in[])</remarks>
        public static int sub2ind(ILArray<fcomplex> A,int [] subscripts) {              
            if (object.Equals(A,null) || A.IsEmpty || subscripts == null || subscripts.Length == 0) 
                throw new ILArgumentException("sub2ind: both A and subscripts must be non-empty!");
            return A.getBaseIndex(subscripts);  
        }
        ...
        /// <returns>sequential index for subscript indices</returns>
        /// <remarks>the function returns the sequential index i into A referencing the same element as would be referenced by the subscript indices. <br />This is an alias for A.getBaseIndex(in[])</remarks>
        public static int sub2ind(ILArray<Int16>    A,int [] subscripts) {              
            if (object.Equals(A,null) || A.IsEmpty || subscripts == null || subscripts.Length == 0) 
                throw new ILArgumentException("sub2ind: both A and subscripts must be non-empty!");
            return A.getBaseIndex(subscripts);  
        }
        ...
        /// <returns>sequential index for subscript indices</returns>
        /// <remarks>the function returns the sequential index i into A referencing the same element as would be referenced by the subscript indices. <br />This is an alias for A.getBaseIndex(in[])</remarks>
        public static int sub2ind(ILArray<Int32>    A,int [] subscripts) {              
            if (object.Equals(A,null) || A.IsEmpty || subscripts == null || subscripts.Length == 0) 
                throw new ILArgumentException("sub2ind: both A and subscripts must be non-empty!");
            return A.getBaseIndex(subscripts);  
        }
        ...
        /// <returns>sequential index for subscript indices</returns>
        /// <remarks>the function returns the sequential index i into A referencing the same element as would be referenced by the subscript indices. <br />This is an alias for A.getBaseIndex(in[])</remarks>
        public static int sub2ind(ILArray<Int64>    A,int [] subscripts) {              
            if (object.Equals(A,null) || A.IsEmpty || subscripts == null || subscripts.Length == 0) 
                throw new ILArgumentException("sub2ind: both A and subscripts must be non-empty!");
            return A.getBaseIndex(subscripts);  
        }
        ...
        /// <returns>sequential index for subscript indices</returns>
        /// <remarks>the function returns the sequential index i into A referencing the same element as would be referenced by the subscript indices. <br />This is an alias for A.getBaseIndex(in[])</remarks>
        public static int sub2ind(ILArray<UInt16>   A,int [] subscripts) {              
            if (object.Equals(A,null) || A.IsEmpty || subscripts == null || subscripts.Length == 0) 
                throw new ILArgumentException("sub2ind: both A and subscripts must be non-empty!");
            return A.getBaseIndex(subscripts);  
        }
        ...
        /// <returns>sequential index for subscript indices</returns>
        /// <remarks>the function returns the sequential index i into A referencing the same element as would be referenced by the subscript indices. <br />This is an alias for A.getBaseIndex(in[])</remarks>
        public static int sub2ind(ILArray<UInt32>   A,int [] subscripts) {              
            if (object.Equals(A,null) || A.IsEmpty || subscripts == null || subscripts.Length == 0) 
                throw new ILArgumentException("sub2ind: both A and subscripts must be non-empty!");
            return A.getBaseIndex(subscripts);  
        }
        ...
        /// <returns>sequential index for subscript indices</returns>
        /// <remarks>the function returns the sequential index i into A referencing the same element as would be referenced by the subscript indices. <br />This is an alias for A.getBaseIndex(in[])</remarks>
        public static int sub2ind(ILArray<UInt64>   A,int [] subscripts) {              
            if (object.Equals(A,null) || A.IsEmpty || subscripts == null || subscripts.Length == 0) 
                throw new ILArgumentException("sub2ind: both A and subscripts must be non-empty!");
            return A.getBaseIndex(subscripts);  
        }
        ...
        /// <returns>sequential index for subscript indices</returns>
        /// <remarks>the function returns the sequential index i into A referencing the same element as would be referenced by the subscript indices. <br />This is an alias for A.getBaseIndex(in[])</remarks>
        public static int sub2ind(ILArray<char>     A,int [] subscripts) {              
            if (object.Equals(A,null) || A.IsEmpty || subscripts == null || subscripts.Length == 0) 
                throw new ILArgumentException("sub2ind: both A and subscripts must be non-empty!");
            return A.getBaseIndex(subscripts);  
        }
