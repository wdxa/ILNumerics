...
<hycalper>
    ...
    <type>
        ...
        <destination>Single.IsInfinity</destination>
                            ...
                            fixed ( double * pInArr = A.m_data) {
                                ...
                                while (secDimIdx < secDimEnd) {
                                    ...
                                    while (leadDimIdx < leadDimEnd) {   // HC00
                                        ...
                                        *tmpOut =  Double.IsInfinity ( *( tmpIn + *leadDimIdx++ ) )  ?(byte)1:(byte)0;
                                        tmpOut += incOut;
                                    }
                                }
                            }
                            ...
                            fixed ( float * pInArr = A.m_data) {
                                ...
                                while (secDimIdx < secDimEnd) {
                                    ...
                                    while (leadDimIdx < leadDimEnd) {   // HC00
                                        ...
                                        *tmpOut =  Single.IsInfinity ( *( tmpIn + *leadDimIdx++ ) )  ?(byte)1:(byte)0;
                                        tmpOut += incOut;
                                    }
                                }
                            }
                ...
                unsafe {
                    ...
                    fixed ( float * pInArr = A.m_data) {
                        ...
                        while (tmpOut < lastElement) { // HC02
                            ...
                            *tmpOut++ =  Single.IsInfinity ( *tmpIn++ )  ?(byte)1:(byte)0;
                        }
                    }
                }
                #endregion
