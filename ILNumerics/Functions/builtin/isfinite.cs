...
<hycalper>
    ...
    <type>
        ...
        <destination>isfinite</destination>
        <destination>isfinite</destination>
        <destination>isfinite</destination>
        <destination>isfinite</destination>
    </type>
    <type>
        ...
        <destination>complex.IsFinite</destination>
        <destination>fcomplex.IsFinite</destination>
        <destination>isfinite</destination>
        <destination>isfinite</destination>
    </type>
    <type>
    ...
    <type>
        ...
        <destination>Finds finite value elements</destination>
        <destination>Finds finite value elements</destination>
        <destination>Finds finite value elements</destination>
        <destination>Finds finite value elements</destination>
    </type>
    <type>
        ...
        <destination>Logical array with 1 if the corresponding elements of input array is finite, 0 else.</destination>
        <destination>Logical array with 1 if the corresponding elements of input array is finite, 0 else.</destination>
        <destination>Logical array with 1 if the corresponding elements of input array is finite, 0 else.</destination>
        <destination>Logical array with 1 if the corresponding elements of input array is finite, 0 else.</destination>
    </type>
...
namespace ILNumerics.BuiltInFunctions {
    public partial class ILMath {
        ...
        /// <param name="input">input array or element</param>
        /// <returns>true for finite values</returns>
        public static bool isfinite (float input) { 
...
// DO NOT EDIT INSIDE THIS REGION !! CHANGES WILL BE LOST !! 
        ...
        public static  ILLogicalArray  isfinite ( ILArray<double> A) {
            if (A.IsEmpty)
                            ...
                            fixed ( double * pInArr = A.m_data) {
                                ...
                                while (secDimIdx < secDimEnd) {
                                    ...
                                    while (leadDimIdx < leadDimEnd) {   // HC00
                                        ...
                                        *tmpOut =  isfinite ( *( tmpIn + *leadDimIdx++ ) )  ?(byte)1:(byte)0;
                                        tmpOut += incOut;
                                    }
                                }
                            }
                ...
                unsafe {
                    ...
                    fixed ( double * pInArr = A.m_data) {
                        ...
                        while (tmpOut < lastElement) { // HC02
                            ...
                            *tmpOut++ =  isfinite ( *tmpIn++ )  ?(byte)1:(byte)0;
                        }
                    }
                }
                #endregion
        ...
        /// <remarks><para>If the input array is empty, an empty array will be returned.</para>
        /// <para>The array returned will be a dense array.</para></remarks>
        public static  ILLogicalArray  isfinite ( ILArray<float> A) {
            if (A.IsEmpty)
                return  ILLogicalArray .empty(); 
            ILDimension inDim = A.Dimensions;
            byte [] retDblArr;
        ...
        /// <remarks><para>If the input array is empty, an empty array will be returned.</para>
        /// <para>The array returned will be a dense array.</para></remarks>
        public static  ILLogicalArray  isfinite ( ILArray<fcomplex> A) {
            if (A.IsEmpty)
                return  ILLogicalArray .empty(); 
            ILDimension inDim = A.Dimensions;
            byte [] retDblArr;
                            ...
                            fixed ( fcomplex * pInArr = A.m_data) {
                                ...
                                while (secDimIdx < secDimEnd) {
                                    ...
                                    while (leadDimIdx < leadDimEnd) {   // HC00
                                        ...
                                        *tmpOut =  fcomplex.IsFinite ( *( tmpIn + *leadDimIdx++ ) )  ?(byte)1:(byte)0;
                                        tmpOut += incOut;
                                    }
                                }
                            }
                ...
                unsafe {
                    ...
                    fixed ( fcomplex * pInArr = A.m_data) {
                        ...
                        while (tmpOut < lastElement) { // HC02
                            ...
                            *tmpOut++ =  fcomplex.IsFinite ( *tmpIn++ )  ?(byte)1:(byte)0;
                        }
                    }
                }
                #endregion
                            ...
                            fixed ( complex * pInArr = A.m_data) {
                                ...
                                while (secDimIdx < secDimEnd) {
                                    ...
                                    while (leadDimIdx < leadDimEnd) {   // HC00
                                        ...
                                        *tmpOut =  complex.IsFinite ( *( tmpIn + *leadDimIdx++ ) )  ?(byte)1:(byte)0;
                                        tmpOut += incOut;
                                    }
                                }
                            }
