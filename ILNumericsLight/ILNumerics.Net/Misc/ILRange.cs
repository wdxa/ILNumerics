...
<type>
    ...
    <destination><![CDATA[ILArray<int>]]></destination>
...
<type>
    ...
    <destination>opint_intint</destination>
...
<type>
    ...
    <destination>opint_int</destination>
...
<type>
    ...
    <destination>ILIntFunctionsIntInt</destination>
...
<type>
    ...
    <destination>ILIntFunctionsInt</destination>
...
<type>
    ...
    <destination>IntUnaryIntOperator</destination>
...
<type>
    ...
    <destination>int.MaxValue</destination>
...
// DO NOT EDIT INSIDE THIS REGION !! CHANGES WILL BE LOST !! 
                        ...
                        m_numberOfElements *= curLen; 
                    } else if (ranges[d] is  ILArray<int> ) {
			            ILArray<int> srcArray = ( ILArray<int> ) ranges[d]; 
                        int [] mdata = srcArray.m_data; 
                        if (curLen > 1) {
                            m_nonSingletonDimensions++; 
                            // determine spacing also 
                            int n = 0;
