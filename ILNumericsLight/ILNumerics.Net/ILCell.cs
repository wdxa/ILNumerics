	...
	public class ILCell : ILArray<ILBaseArray> {
        ...
        public new ILBaseArray this[params ILBaseArray[] indices] {
            get{
                ...
                if (ret.IsScalar) {
                    ...
                    if (ret is ILArray<ILBaseArray>) {
                        return new ILCell((ILArray<ILBaseArray>)ret).C; 
                    } else {
            ...
            set { 
                if (Object.ReferenceEquals(value,null)) {
                    ...
                    base[indices] = (ILArray<ILBaseArray>)((ILCell)value).C;
                } else {
                    base[indices] = (ILBaseArray)value.Clone(); 
                }
            }
        }
        ...
        internal virtual ILCell DeepReferenceElements() {
            ...
            for (int i = 0; i < len; i++) {
                ...
                if (a is ILCell) 
                    SetValue(((ILCell)a).C,i); 
                else {
                    if (!Object.ReferenceEquals(a,null))
                        SetValue((ILBaseArray)a.Clone(),i);
                }
            }
            return this;
        }
